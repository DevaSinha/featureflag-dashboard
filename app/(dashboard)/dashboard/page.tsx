...
export default function DashboardPage() {
  ...
  }, [orgForm, refreshOrganizations, setOrganization]);
  ...
  }, [organization, projectForm, refreshProjects, setProject]);
        ...
        <Dialog open={orgDialogOpen} onOpenChange={setOrgDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Set up your team or company workspace.
              </DialogDescription>
            </DialogHeader>
            {orgError && (
            ...
            <DialogFooter>
              ...
              <Button
                ...
                disabled={creatingOrg || !orgForm.name}
              >
                {creatingOrg && (
  ...
  if (!project) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[500px] text-center">
        ...
        <p className="text-muted-foreground mb-6 max-w-md">
          Projects contain feature flags and experiments. Create one for{" "}
          {organization.name}.
        </p>
        <Dialog
        ...
        >
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Projects help organize your feature flags.
              </DialogDescription>
            </DialogHeader>
            {projectError && (
              <div className="p-3 text-sm text-red-500 bg-red-50 dark:bg-red-950/20 rounded-lg">
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <div className="h-6 w-6 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-600 text-xs">
                  ✓
                </div>
